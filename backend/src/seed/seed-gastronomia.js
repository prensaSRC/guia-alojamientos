...
// 2 locales de demostración por cada categoría gastronómica (7 x 2 + 4 = 18).
...
const LOCALES = [
  ...
  // RESTOBARES (4: 2 bares + 2 parrillas)
  {
    nombre: 'Bar El Encuentro',
    categoria: 'restobares',
  ...
  // ROTISERÍA Y COMIDAS PARA LLEVAR (4: 2 rotiserías + 2 fast food)
  {
  ...
  // ALFAJORES Y DELÍCIAS ARTESANALES (2)
  {
    nombre: 'Alfajores La Estancia',
    categoria: 'alfajores y delicias artesanales',
    direccion: 'Av. Giagetto 550',
    telefonos: [
      { tipo: 'fijo', numero: '(03546) 42-1133', e164: '+5493546421133', whatsapp: '5493546421133' },
    ],
    web: '',
  },
  {
    nombre: 'Delicias Artesanales Doña Marta',
    categoria: 'alfajores y delicias artesanales',
    direccion: 'Dalmacio Vélez 300',
    telefonos: [
      { tipo: 'celular', numero: '(03546) 15-22-4455', e164: '+5493546224455', whatsapp: '5493546224455' },
    ],
    web: '',
  },
];
